#!/usr/bin/env python3
"""
Complete pipeline for Tifa Lockhart deck: Fetch → Generate → PDF
"""
...
if __name__ == "__main__":
    print("💪 Tifa Lockhart Deck Pipeline Starting desu!\n")

    # Step 1: Fetch cards from Scryfall
    print("=" * 70)
    print("STEP 1: Fetching cards from Scryfall")
    print("=" * 70)
    exit_code = fetch_resources_from_list(
        resource_list_file="decklists/tifa_lockhart.txt",
        output_dir="images",
        manifest_path=".claude/state/tifa_manifest.json",
    ...
    output_path = generate_document(
        ...
        output_path="outputs/tifa_lockhart.pptx"
    )
    ...
    print("\n" + "=" * 70)
    print("✨ TIFA LOCKHART DECK COMPLETE! ✨")
    print("=" * 70)
